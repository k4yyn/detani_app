...
@section('content')
    ...
    <div class="bg-white rounded-lg shadow-sm p-4 md:p-6 mb-6">
        <div class="flex flex-col sm:flex-row justify-between items-start gap-4">
            <div class="flex-1">
                <h2 class="text-xl md:text-2xl font-bold text-green-800 mb-2">Laporan Transaksi Minggu Ini</h2>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    ...
                    <tfoot class="bg-gray-50">
                        <tr class="border-t-2 border-green-800">
                            ...
                            <td colspan="3" class="px-3 md:px-6 py-4 md:py-6 font-bold text-lg md:text-xl text-blue-700">
                                <div class="bg-blue-100 rounded-lg px-3 py-2 inline-block">
