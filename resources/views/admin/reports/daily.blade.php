...
@section('content')
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        ...
        <div class="flex-1 flex flex-col items-center text-center mt-4 md:mt-0">
            <h2 class="text-xl md:text-2xl font-bold text-white">Laporan Transaksi Hari ini</h2>
            <span class="text-sm text-gray-300 mt-1">{{ now()->format('d F Y') }}</span>
        </div>

        <div class="flex-shrink-0 mt-4 md:mt-0">
            <button id="exportExcel" 
                    class="w-full md:w-auto bg-orange-100 hover:bg-orange-200 border border-orange-300 px-4 py-2.5 text-orange-700 rounded-lg text-sm font-medium flex items-center justify-center transition-all duration-200 hover:shadow-sm">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        @foreach($groupOrder as $group)
                            @if(isset($groupedTransaksis[$group]) && $groupedTransaksis[$group]->count() > 0)
                                ...
                                @if(!$loop->last)
                                    <tr>
                                        <td colspan="7" class="h-4 bg-gray-100"></td>
                                    </tr>
                                @endif
                            @endif
                        @endforeach
                            ...
                            <tr>
                                <td colspan="7" class="px-6 py-12 text-center">
                                    <div class="flex flex-col items-center justify-center">
                                        ...
                                        <p class="text-lg font-medium text-gray-500 mb-1">Tidak ada transaksi hari ini</p>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-green-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-gray-900 mt-1">{{ number_format($totalTransaksi) }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-green-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-green-900 mt-1">Rp {{ number_format($total, 0, ',', '.') }}</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-green-200 p-6">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-2xl font-bold text-purple-900 mt-1">Rp {{ number_format($rataTransaksi, 0, ',', '.') }}</p>
                </div>
