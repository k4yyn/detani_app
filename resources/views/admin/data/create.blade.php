    ...
    <div class="container mx-auto px-4 max-w-4xl">
            ...
            <form action="{{ route('admin.data.store') }}" method="POST" class="p-8">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div class="relative">
                            <input type="text"
                                   class="w-full px-4 py-3 bg-gradient-to-r from-blue-50 to-indigo-50 border-2 border-blue-200 rounded-xl text-blue-800 font-mono font-bold text-center tracking-wider focus:outline-none cursor-not-allowed"
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <input type="text"
                               name="nama_barang"
                               class="w-full px-4 py-3 border-2 border-blue-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 hover:border-blue-300"
                    ...
                    <div class="lg:col-span-2 grid grid-cols-1 sm:grid-cols-3 gap-4">
                        ...
                        <div>
                            ...
                            <div class="relative">
                                <span class="absolute left-4 top-1/2 transform -translate-y-1/2 text-blue-600 font-semibold">Rp</span>
                                <input type="number"
                                       name="harga_pokok"
                ...
                <!-- Action Buttons -->
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4 mt-8 pt-6 border-t border-blue-100">
                    ...
                    <button type="submit"
                            class="w-full sm:w-auto inline-flex items-center justify-center px-8 py-3 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 transition-all duration-200 group">
        ...
        <div class="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-4">
            <div class="flex items-start">
                ...
                <div>
                    <h4 class="text-blue-800 font-semibold mb-1">Tips Pengisian</h4>
