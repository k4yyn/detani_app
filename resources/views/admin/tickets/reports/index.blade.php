        ...
        <form method="GET" action="{{ route('admin.tickets.reports.index') }}" class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="flex items-end">
                    <button 
                        type="submit"
                        class="w-full bg-green-800 hover:bg-green-900 text-white font-medium py-2 px-4 rounded-md shadow-sm transition duration-200 flex items-center justify-center">
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-blue-700 mb-1">Stok Awal</p>
                    ...
                    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-yellow-700 mb-1">Tiket Terjual</p>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="text-sm font-medium text-green-700 mb-1">Sisa Tiket</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
                    <div class="bg-purple-50 border border-purple-200 rounded-lg p-4">
                        <p class="text-sm font-medium text-purple-700 mb-1">Pendapatan Kotor</p>
                        <p class="text-2xl font-bold text-purple-800">Rp {{ number_format($totalRevenue, 0, ',', '.') }}</p>
                    </div>
                    <div class="bg-red-50 border border-red-200 rounded-lg p-4">
                        <p class="text-sm font-medium text-red-700 mb-1">Total Diskon</p>
                        <p class="text-2xl font-bold text-red-800">Rp {{ number_format($totalDiscount, 0, ',', '.') }}</p>
                    </div>
                    <div class="bg-emerald-50 border border-emerald-200 rounded-lg p-4">
                        <p class="text-sm font-medium text-emerald-700 mb-1">Pendapatan Bersih</p>
        ...
        <div class="bg-white shadow-sm rounded-lg border border-gray-200">
            <div class="p-12 text-center">
                ...
                <a href="{{ route('admin.tickets.create') }}" 
                   class="inline-flex items-center bg-green-800 hover:bg-green-900 text-white font-medium py-2 px-4 rounded-lg transition duration-200">
                    <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
