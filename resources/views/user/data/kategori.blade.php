    ...
    <div class="container mx-auto px-4 max-w-7xl">
            ...
            <div class="bg-gradient-to-r from-amber-500 to-orange-500 px-8 py-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-amber-100 mt-2 text-lg">Kelola kategori barang/jasa dengan mudah dan efisien</p>
                    </div>
                ...
                <div class="flex-grow max-w-md">
                    <div class="relative">
                        <input
                            ...
                            class="w-full pl-4 pr-12 py-3 border-2 border-amber-200 rounded-xl focus:ring-2 focus:ring-amber-500 focus:border-amber-500 transition-all duration-200 hover:border-amber-300"
                        />
                        <button class="absolute right-2 top-1/2 transform -translate-y-1/2 bg-amber-500 hover:bg-amber-600 text-white rounded-lg p-2 transition-colors">
        ...
        <div class="space-y-4">
            @forelse ($kategoris as $kategori)
                <div class="bg-white rounded-2xl shadow-lg border border-amber-100 overflow-hidden hover:shadow-xl transition-all duration-200">
                    <a href="{{ route('user.data.by-kategori', $kategori->kategori) }}" class="block">
                        <div class="p-6 hover:bg-amber-50 transition-colors">
                            <div class="flex items-center justify-between">
                                ...
                                <div class="flex items-center space-x-3">
                                    <button class="p-2 text-amber-600 hover:bg-amber-100 rounded-lg transition-colors" title="Edit">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
